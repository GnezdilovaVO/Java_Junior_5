...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            ...
            throw new RuntimeException("Не удалось начать прослушивать порт " + PORT);
        }
    }
}
...
//            out.println("Подключение " + clientSocket + " произошло успешно");
            while (true) {
                ...
                System.out.println("Получено сообщение от" + clientSocket + ": " + input);
                ...
                if (Objects.equals("exit", input)) {
                    System.out.println("Клиет " + clientSocket + " отключился");
                    break;
                }
            }
        } catch (IOException e) {
